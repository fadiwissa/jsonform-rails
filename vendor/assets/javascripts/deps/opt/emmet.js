/**
 * Packaged version of `emmet.js` from: https://github.com/cloud9ide/emmet-core
 * 
 * This is the same as that version except without the Underscore library bundled with it
 * (that should be loaded on the page first).
 */
